      ...
      <main className={`${styles.page} bg-white text-[#17364f]`}>
        <section className="px-5 pb-12 pt-12 text-center sm:px-6 sm:pb-16 sm:pt-16">
          <ScrollReveal>
            ...
            <p className="mx-auto mt-3 max-w-xl text-[10px] text-[#718697] sm:text-sm">Get in touch with our team. We typically respond within 24 hours.</p>
          </ScrollReveal>
          <div className="mx-auto mt-16 grid max-w-5xl gap-8 text-left lg:grid-cols-[1fr_1.05fr]">
            <ScrollReveal>
              <div>
                ...
                <div className="mt-5 space-y-4">
                  ...
                  ].map(([Icon, label, value]) => <div key={label as string} className="flex gap-3"><span className={styles.contactIcon}><Icon className="h-3.5 w-3.5" /></span><div><p className="text-[8px] text-[#718697]">{label as string}</p><p className="mt-0.5 text-[9px] text-[#17364f]">{value as string}</p></div></div>)}
                </div>
                <div className="mt-6 border-t border-[#d9e5eb] pt-4"><h3 className="text-[9px] font-bold">Product-Specific Contact</h3><div className="mt-3 space-y-2"><div className={styles.productContact}><b>VORN HR Product</b><span>hr@abhivorn.com · www.vornhr.com</span></div><div className={styles.productContact}><b>VorQard (Healthcare)</b><span>support@vorqard.com · www.vorqard.com</span></div></div></div>
            ...
            <ScrollReveal delay={120}>
              <form onSubmit={(event) => { event.preventDefault(); setSent(true); }} className={styles.form}>
                ...
                {sent && <p className="mt-2 rounded bg-green-50 p-2 text-[8px] text-green-700">Thanks! Your message has been sent successfully.</p>}
                ...
                <label className="mt-3 flex items-start gap-1 text-[7px] text-[#718697]"><input type="checkbox" required className="mt-px" /> I agree to be contacted by Abhivorn Technologies regarding my inquiry.</label>
        ...
        <section className="bg-[#f7fafc] px-5 py-12 sm:px-6 sm:py-16">
          <ScrollReveal><div className="text-center"><h2 className="text-xl font-bold sm:text-2xl">Frequently Asked Questions</h2><p className="mt-2 text-[9px] text-[#718697]">Quick answers to common questions</p></div></ScrollReveal>
