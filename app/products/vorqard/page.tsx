  ...
  return (
    <>
      ...
      <main className={`${styles.page} bg-white text-[#17364f]`}>
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-9 lg:grid-cols-[1fr_1.02fr]">
            <ScrollReveal>
              <div>
                ...
                <p className="mt-4 max-w-md text-[15px] leading-relaxed text-[#718697] sm:text-lg">Revolutionize patient care with smart QR-based identification, streamlined appointments, and comprehensive healthcare analytics. Built for modern clinics and hospitals.</p>
        ...
        <section className="bg-[#08aec8] px-5 py-12 text-center text-white sm:py-14"><ScrollReveal><h2 className="text-2xl font-bold tracking-[-0.02em] sm:text-3xl">Ready to Modernize Your Healthcare Facility?</h2><p className="mx-auto mt-3 max-w-lg text-[14px] text-white/85">Join our beta program and transform patient care with VorQard’s innovative QR-based system.</p><div className="mt-5 flex justify-center gap-2"><Link href="/contact" className={styles.lightButton}>Request Demo <ArrowRight className="h-3 w-3" /></Link><Link href="/contact" className={styles.ctaOutline}>Contact Sales</Link></div></ScrollReveal></section>
      </main>
      <Footer />
    </>
  );
